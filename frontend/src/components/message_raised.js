...
const Message_raised = () => {
  ...
  const handlemessage = (id) => {
    localStorage.setItem('complaint_id_message_victim', id);
    navigate('/OTP/Dashboard/Choose_message_system/Message_raised/Message_as_victim');
  }
